export class Direccion {
    // _ se ponen cuando son atributos privados
    //private _idDireccion: number;

    //Para este constructor de tipo firma no hace falta tener tambien declarado los atributos
    constructor(
        private _idDireccion: number, 
    ...
    //En este caso son redundante loe getters
